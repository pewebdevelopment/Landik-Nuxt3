     ...
     <section class="py-20">
        <div class="container">
            ...
            <div class="grid grid-cols-1 mt-16">
                <div id="tab-buttons" class="flex items-center gap-3 justify-center">
                    <a href="javascript:void(0)" onclick="changeTab(event, 0)" class="active-price-tab font-semibold rounded-[5px] block py-2 px-4 bg-white text-dark border-2 border-[#e7e7e7]/50">
                        Monthly
                    </a>
                    <a href="javascript:void(0)" onclick="changeTab(event, 1)" class="font-semibold rounded-[5px] block py-2 px-4 bg-white text-dark border-2 border-[#e7e7e7]/50">
                        Yearly
                    </a>
                </div>
            </div>
